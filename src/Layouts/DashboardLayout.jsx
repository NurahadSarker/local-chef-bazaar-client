        ...
        <div className='bg-base-300'>
            <div className="drawer lg:drawer-open poppins">
                ...
                <div className="drawer-content">
                    ...
                    <nav className="navbar w-full bg-base-300 shadow-md">
                        <label htmlFor="my-drawer-4" aria-label="open sidebar" className="btn btn-square btn-ghost">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="my-1.5 inline-block size-5.5">
                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64 shadow-lg">
                        ...
                        {role === "user" && (
                            <ul className="menu w-full grow mt-2">
                                <li><Link to={'/'}><FiHome size={20} /><span className="is-drawer-close:hidden">Homepage</span></Link></li>
                                <li><Link to={'my-profile'}><CgProfile size={20} /><span className="is-drawer-close:hidden">My Profile</span></Link></li>
                                <li><Link to={'my-orders'}><FaShoppingCart size={20} /><span className="is-drawer-close:hidden">My Orders</span></Link></li>
                                <li><Link to={'my-reviews'}><MdReviews size={20} /><span className="is-drawer-close:hidden">My Reviews</span></Link></li>
                                <li><Link to={'favorite-meals'}><MdFavorite size={20} /><span className="is-drawer-close:hidden">Favorite Meals</span></Link></li>
                            </ul>
                        )}
                        ...
                        {role === "chef" && (
                            <ul className="menu w-full grow mt-2">
                                <li><Link to={'/'}><FiHome size={20} /><span className="is-drawer-close:hidden">Homepage</span></Link></li>
                                <li><Link to={'my-profile'}><CgProfile size={20} /><span className="is-drawer-close:hidden">My Profile</span></Link></li>
                                <li><Link to={'create-meals'}><MdAddBox size={20} /><span className="is-drawer-close:hidden">Create Meals</span></Link></li>
                                <li><Link to={'my-meals'}><MdRestaurantMenu size={20} /><span className="is-drawer-close:hidden">My Meals</span></Link></li>
                                <li><Link to={'order-request'}><FaClipboardList size={20} /><span className="is-drawer-close:hidden">Order Request</span></Link></li>
                            </ul>
                        )}
                        ...
                        {role === "admin" && (
                            <ul className="menu w-full grow mt-2">
                                <li><Link to={'/'}><FiHome size={20} /><span className="is-drawer-close:hidden">Homepage</span></Link></li>
                                <li><Link to={'my-profile'}><CgProfile size={20} /><span className="is-drawer-close:hidden">My Profile</span></Link></li>
                                <li><Link to={'manage-users'}><MdManageAccounts size={20} /><span className="is-drawer-close:hidden">Manage Users</span></Link></li>
                                <li><Link to={'manage-request'}><MdReviews size={20} /><span className="is-drawer-close:hidden">Manage Requests</span></Link></li>
                                <li><Link to={'platform-statistics'}><MdInsights size={20} /><span className="is-drawer-close:hidden">Platform Statistics</span></Link></li>
                            </ul>
                        )}
